...
<aside class="callout" aria-label="Note about inline conditionals">
  The inline conditionals are used for the sake of brevity. They illustrate how the initial state would be derived
...
This makes the intent clearer, simplifies JavaScript interaction, and keeps the state declarative rather than relying on imperative style changes, adhering to <Link href="https://en.wikipedia.org/wiki/Rule_of_least_power">the Rule of Least Power</Link>.
