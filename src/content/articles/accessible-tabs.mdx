...
It also respects the <Link href="https://www.w3.org/2001/tag/doc/leastPower.html">Rule of Least Power</Link>, relying on HTML as much as possible before playing the CSS card.
