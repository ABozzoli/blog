...
This makes the intent clearer, simplifies JavaScript interaction, and keeps the state declarative rather than relying on imperative style changes, closely following the <Link href="https://en.wikipedia.org/wiki/Rule_of_least_power">Rule of Least Power</Link> too.
